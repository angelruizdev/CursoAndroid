...
//le implementamos(implements)la interface a esta clase e implementamos también su/s método/s de esta interface
public class PlayeraH extends RopaPadre implements IDevolucion{
